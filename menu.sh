...
echo -e " [${WHITE}05${NC}]${RED} •${NC} ${CYAN}S-SOCK MENU     $NC  [${WHITE}16${NC}]${RED} • ${NC}${CYAN}SPEEDTEDT  $NC"
echo -e " [${WHITE}06${NC}]${RED} •${NC} ${CYAN}TENDANG         $NC  [${WHITE}17${NC}]${RED} • ${NC}${CYAN}CEK BANDWIDTH USE $NC"
echo -e " [${WHITE}07${NC}]${RED} •${NC} ${CYAN}AUTO REBOOT     $NC  [${WHITE}18${NC}]${RED} • ${NC}${CYAN}LIMMIT SPEED $NC"
echo -e " [${WHITE}08${NC}]${RED} •${NC} ${CYAN}REBOOT          $NC  [${WHITE}19${NC}]${RED} • ${NC}${CYAN}WEBMIN $NC"
